...
public enum GherkinCompletionNames {
    ...
    BACKGROUND("Background",
            "Background: ",
            "Allowed skills",
            "<html><span style=\"color: blue\">         A  Background is a special scenario executed before each scenario in the feature file.         It starts with the Background keyword instead of the usual Scenario.</span><br/><br/>        Example: <br/><br/><span style=\"color: gray;font-style: italic\">             <b><span style=\"color: blue\">Background:</span>Allowed skills</b></span> <br/>            <span style=\"color: blue\">&nbsp;&nbsp;&nbsp;&nbsp;Given</span> the following skills are allowed<br/>            <span style=\"color: purple\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;| katana &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|<br/>            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;| karate-kick     |<br/>           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;| roundhouse-kick |<br/><br/></span>             If a feature file background starts becoming long or complex, it is often a sign that you are describing how the context needs to be set up rather than what the context is. Separate the specification of the context from the procedure to set it up and automate the procedure using step definitions.<br/><br/><a href=\"http://cuke4ninja.com/toc.html\">cuke4ninja.com</a></html>",
            "block",
            2,
            "development/downright/cucumberbeans/resources/icons/block.png",
            "development/downright/cucumberbeans/resources/icons/block"),
    ...
    IN_ORDER("In order",
            ...
            6,
            "development/downright/cucumberbeans/resources/icons/narrative.png",
            "development/downright/cucumberbeans/resources/icons/narrative-inorder"),
    I_WANT  ("I want",
            "I want ",
            ...
            7,
            "development/downright/cucumberbeans/resources/icons/narrative.png",
            "development/downright/cucumberbeans/resources/icons/narrative-iwant");
