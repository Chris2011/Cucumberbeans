...
import development.downright.cucumberbeans.GherkingDataObject;
 ...
 * @author SessonaD
 */
public class PaletteBackground extends BasePaletteActiveEditor {

    @Override
    public String createBody() {
        try {
            ScenarioDialog dialogue = new ScenarioDialog(null, true, GherkinCompletionNames.BACKGROUND);
            //center on screen
