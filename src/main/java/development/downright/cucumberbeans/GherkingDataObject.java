...
@DataObject.Registration(iconBase = "development/downright/cucumberbeans/resources/icons/cuc.png", displayName = "#LBL_Cuc_LOADER", mimeType = "text/x-gherkin", position = 300)
