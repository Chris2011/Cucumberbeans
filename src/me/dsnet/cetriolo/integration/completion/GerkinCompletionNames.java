...
public enum GerkinCompletionNames {
    ...
    FEATURE ("feature", 
            ...
            "me/dsnet/cetriolo/resources/icons/narrative"),
    ...
    private GerkinCompletionNames(String word, String display,String documentation,String type,int priority,String baseIcon,String otherIcon) {
        this.word = word;
